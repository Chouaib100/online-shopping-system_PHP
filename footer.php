						...
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Maroc</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>+212 6000000000</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>chouaibzouine3@gmail.com</a></li>
								</ul>
							</div>
						</div>
